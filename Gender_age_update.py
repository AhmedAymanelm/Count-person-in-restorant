...
padding = 20
track_info = {}
frames_to_stabilize = 3  # عدد الإطارات لتثبيت العمر والجندر
...
while True:
    ...
    for track in tracks:
        ...
        # تثبيت البوكس على الوجه مع padding ثابت
        box_width = x2 - x1
        box_height = y2 - y1
        x1 = max(0, x1 - padding)
        y1 = max(0, y1 - padding)
        ...
        if track_id not in track_info:
            ...
            # تحديث الـ deque للصندوق الموجود
